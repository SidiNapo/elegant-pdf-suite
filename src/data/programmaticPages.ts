// Programmatic SEO landing pages for long-tail, security-led queries the big
// competitors neglect. Each page targets one specific intent and routes the
// user to the matching in-browser tool. Rendered at /p/:slug.
...
export const programmaticPages: ProgrammaticPage[] = [
  {
    ...
    fr: {
      ...
      metaDescription: 'Réduisez votre PDF pour l\'envoyer par Gmail sans dépasser la limite de 25 Mo. Gratuit, 100 % local, sans téléversement.',
      ...
      intro: 'Gmail limite les pièces jointes à 25 Mo. Réduisez la taille de votre PDF en quelques secondes, directement dans votre navigateur, sans téléverser vos fichiers nulle part.',
      paragraphs: [
    ...
    en: {
      ...
      metaDescription: 'Shrink your PDF to email it via Gmail without exceeding the 25 MB limit. Free, 100% local, no upload.',
      keywords: 'compress pdf for gmail, reduce pdf email, pdf too big gmail',
      h1: 'Compress a PDF to send it via Gmail',
      intro: 'Gmail caps attachments at 25 MB. Reduce your PDF size in seconds, right in your browser, without uploading your files anywhere.',
      paragraphs: [
  ...
  },
  {
    ...
    fr: {
      ...
      metaDescription: 'Compressez votre PDF jusqu\'à environ 200 Ko pour les formulaires en ligne. Gratuit, 100 % local, sans téléversement.',
      keywords: 'réduire pdf 200ko, compresser pdf 200 ko, pdf 200kb formulaire',
      h1: 'Réduire un PDF à environ 200 Ko',
      intro: 'De nombreux portails administratifs exigent des PDF légers. Réduisez votre fichier pour respecter ces limites strictes, sans installation.',
      paragraphs: [
    ...
    en: {
      ...
      metaDescription: 'Compress your PDF down to around 200 KB for online forms. Free, 100% local, no upload.',
      keywords: 'reduce pdf to 200kb, compress pdf 200 kb, pdf 200kb form',
      h1: 'Reduce a PDF to around 200 KB',
      intro: 'Many government portals require lightweight PDFs. Shrink your file to meet these strict limits, with no installation.',
      paragraphs: [
  ...
  },
  {
    ...
    fr: {
      ...
      metaDescription: 'Transformez vos images PNG en PDF gratuitement. 100 % local dans le navigateur, sans téléversement ni filigrane.',
      keywords: 'png en pdf, convertir png pdf, image png en pdf gratuit',
      h1: 'Convertir une image PNG en PDF',
      intro: 'Réunissez une ou plusieurs images PNG dans un PDF propre, idéal pour partager des captures d\'écran ou des documents numérisés.',
      paragraphs: [
    ...
    en: {
      ...
      metaDescription: 'Turn your PNG images into PDF for free. 100% local in-browser, no upload, no watermark.',
      keywords: 'png to pdf, convert png pdf, png image to pdf free',
      h1: 'Convert a PNG image to PDF',
      intro: 'Combine one or more PNG images into a clean PDF, ideal for sharing screenshots or scanned documents.',
      paragraphs: [
  ...
  },
  {
    ...
    fr: {
      ...
      metaDescription: 'Combinez vos PDF sans les envoyer sur un serveur. Traitement 100 % local dans le navigateur, idéal pour documents confidentiels.',
      ...
      intro: 'Pour les documents sensibles, le plus sûr est de ne jamais les envoyer en ligne. Notre outil fusionne vos PDF entièrement dans votre navigateur.',
      paragraphs: [
    ...
    en: {
      ...
      metaDescription: 'Combine your PDFs without sending them to a server. 100% local in-browser processing, ideal for confidential documents.',
      keywords: 'merge pdf no upload, secure pdf merge, combine pdf without upload',
      h1: 'Merge PDFs without uploading to a server',
      intro: 'For sensitive documents, the safest path is never sending them online. Our tool merges your PDFs entirely inside your browser.',
      paragraphs: [
...
export const getProgrammaticPage = (slug?: string) =>
  programmaticPages.find((p) => p.slug === slug);
