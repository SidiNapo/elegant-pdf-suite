...
const PdfToJpg = () => {
  ...
  const handleDownload = () => {
    if (images.length > 0) {
      ...
      downloadImagesAsZip(images, baseName);
    }
  };
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                {images.length} page(s) ont été converties en images.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
              {images.slice(0, 8).map((image, index) => (
                <motion.div
                  ...
                  className="glass-card rounded-xl overflow-hidden aspect-[3/4]"
                >
                  <img
                    src={image}
                    alt={`Page ${index + 1}`}
